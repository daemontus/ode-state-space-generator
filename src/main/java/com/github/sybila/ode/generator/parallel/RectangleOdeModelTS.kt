package com.github.sybila.ode.generator.parallel
...
class RectangleOdeModelTS(
        model: OdeModel,
        createSelfLoops: Boolean = true
) : AbstractOdeFragmentTS<MutableSet<Rectangle>>(model, createSelfLoops, RectangleSolver(Rectangle(
