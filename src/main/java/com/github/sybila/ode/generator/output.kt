...
internal fun printJsonRectResults(model: OdeModel, result: Map<String, StateMap<Set<Rectangle>>>): String {
    return printJsonRectResultsParallel(model, result.mapValues { listOf(it.value) })
}

internal fun printJsonRectResultsParallel(model: OdeModel, result: Map<String, List<StateMap<Set<Rectangle>>>>): String {
