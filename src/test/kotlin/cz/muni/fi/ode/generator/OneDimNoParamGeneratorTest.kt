...
import cz.muni.fi.checker.toNodes
...
//One +
    ...
    @Test fun case2() {
        ...
        val s0 = fragment.successors.invoke(IDNode(0))
        assertEquals(nodesOf(c, n0 to c, n1 to c), s0)
        val s1 = fragment.successors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n1 to c), s1)
        val s2 = fragment.successors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), s2)
        ...
        assertEquals(nodesOf(c, n0 to c), p0)
        val p1 = fragment.predecessors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n1 to c, n0 to c), p1)
        val p2 = fragment.predecessors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), p2)
    }
...
//One -
    ...
    @Test fun case4() {
        ...
        assertEquals(nodesOf(c, n0 to c), s0)
        val s1 = fragment.successors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n1 to c, n0 to c), s1)
        val s2 = fragment.successors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), s2)
        val p0 = fragment.predecessors.invoke(IDNode(0))
        assertEquals(nodesOf(c, n0 to c, n1 to c), p0)
        val p1 = fragment.predecessors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n1 to c), p1)
        val p2 = fragment.predecessors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), p2)
...
//Two +
    ...
    @Test fun case5() {
        ...
        val s0 = fragment.successors.invoke(IDNode(0))
        assertEquals(nodesOf(c, n1 to c), s0)
        val s1 = fragment.successors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n1 to c), s1)
        val s2 = fragment.successors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), s2)
        val p0 = fragment.predecessors.invoke(IDNode(0))
        assertEquals(nodesOf(c), p0)
        val p1 = fragment.predecessors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n1 to c, n0 to c), p1)
        val p2 = fragment.predecessors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), p2)
    ...
    @Test fun case6() {
        ...
        assertEquals(nodesOf(c, n0 to c), s0)
        val s1 = fragment.successors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n1 to c, n2 to c), s1)
        val s2 = fragment.successors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), s2)
        val p0 = fragment.predecessors.invoke(IDNode(0))
        assertEquals(nodesOf(c, n0 to c), p0)
        ...
        assertEquals(nodesOf(c, n1 to c), p1)
        val p2 = fragment.predecessors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c, n1 to c), p2)
    }
    //+..0..0..+
    @Test fun case7() {
    ...
    @Test fun case8() {
        ...
        assertEquals(nodesOf(c, n0 to c, n1 to c), s0)
        val s1 = fragment.successors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n2 to c), s1)
        val s2 = fragment.successors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), s2)
        val p0 = fragment.predecessors.invoke(IDNode(0))
        assertEquals(nodesOf(c, n0 to c), p0)
        val p1 = fragment.predecessors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n0 to c), p1)
        val p2 = fragment.predecessors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c, n1 to c), p2)
    }
...
//Two -
    ...
    @Test fun case10() {
        ...
        assertEquals(nodesOf(c, n1 to c), s1)
        val s2 = fragment.successors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c, n1 to c), s2)
        val p0 = fragment.predecessors.invoke(IDNode(0))
        assertEquals(nodesOf(c, n0 to c), p0)
        val p1 = fragment.predecessors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n1 to c, n2 to c), p1)
        val p2 = fragment.predecessors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), p2)
    }
    //-..0..0..-
    ...
    @Test fun case12() {
        ...
        assertEquals(nodesOf(c, n0 to c), s0)
        val s1 = fragment.successors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n0 to c), s1)
        val s2 = fragment.successors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c, n1 to c), s2)
        val p0 = fragment.predecessors.invoke(IDNode(0))
        assertEquals(nodesOf(c, n0 to c, n1 to c), p0)
        val p1 = fragment.predecessors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n2 to c), p1)
        val p2 = fragment.predecessors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), p2)
    }
...
//Three -
    ...
    @Test fun case15() {
        ...
        assertEquals(nodesOf(c, n0 to c), s1)
        val s2 = fragment.successors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n1 to c), s2)
        val p0 = fragment.predecessors.invoke(IDNode(0))
        assertEquals(nodesOf(c, n0 to c, n1 to c), p0)
        val p1 = fragment.predecessors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n2 to c), p1)
        val p2 = fragment.predecessors.invoke(IDNode(2))
        assertEquals(nodesOf(c), p2)
    }
    //-..0..-..-
    @Test fun case16() {
        val fragment = createFragment(-1.0, 0.0, -1.0, -1.0)
...
//Four +
    ...
    @Test fun case17() {
        ...
        assertEquals(nodesOf(c, n0 to c), p1)
        val p2 = fragment.predecessors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n1 to c, n2 to c), p2)
    }
...
//One + / One -
    ...
    @Test fun case24() {
        ...
        assertEquals(nodesOf(c, n0 to c), p0)
        val p1 = fragment.predecessors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n1 to c, n0 to c, n2 to c), p1)
        val p2 = fragment.predecessors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), p2)
    }
    //0..-..+..0
    @Test fun case25() {
        ...
        assertEquals(nodesOf(c, n0 to c), s0)
        val s1 = fragment.successors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n1 to c, n0 to c, n2 to c), s1)
        val s2 = fragment.successors.invoke(IDNode(2))
        assertEquals(nodesOf(c, n2 to c), s2)
        val p0 = fragment.predecessors.invoke(IDNode(0))
        assertEquals(nodesOf(c, n0 to c, n1 to c), p0)
...
//Three - / One +
    ...
    @Test fun case43() {
        ...
        assertEquals(nodesOf(c, n0 to c), p0)
        val p1 = fragment.predecessors.invoke(IDNode(1))
        assertEquals(nodesOf(c, n1 to c, n2 to c, n0 to c), p1)
        val p2 = fragment.predecessors.invoke(IDNode(2))
        assertEquals(nodesOf(c), p2)
    }
