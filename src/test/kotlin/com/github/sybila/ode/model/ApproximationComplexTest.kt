...
class ApproximationComplexTest {
    ...
    fun hillComplexTest() {
        ...
        val model = OdeModel(listOf(
                OdeModel.Variable("v1", Pair(0.0, 10.0), listOf(0.0, 10.0), Pair(8000, 10), listOf(
                        Summand(2.4, -1, listOf(0, 1), listOf(simpleHill.copy(varIndex = 1)))
                )),
                OdeModel.Variable("v2", Pair(0.0, 10.0), listOf(0.0, 10.0), Pair(8000, 10), listOf(
        ...
        val expected = OdeModel(listOf(
                OdeModel.Variable("v1", Pair(0.0, 10.0), complexThresholds, Pair(8000, 10), listOf(
                ...
                OdeModel.Variable("v2", Pair(0.0, 10.0), simpleThresholds, Pair(8000, 10), listOf(
                        Summand(2.4, -1, listOf(0, 1), listOf(
                                RampApproximation(0,
