...
class KotlinDynamicParamsOdeTransitionSystemOneDimTest {
    //dv1 = p(v1/2 + 1) - 1
    ...
    private val fragmentOne = KotlinDynamicParamsOdeTransitionSystem(OdeModel(listOf(v1), listOf(
            OdeModel.Parameter("p1", Pair(0.0, 2.0))
    )), true,"C:\\Users\\Jakub\\Desktop\\ode-generator\\build\\libs\\ode-generator-1.3.3-2-all.jar")

    private val fragmentTwo = KotlinDynamicParamsOdeTransitionSystem(OdeModel(listOf(v2), listOf(
            OdeModel.Parameter("p2", Pair(-2.0, 2.0))
    )), true,"C:\\Users\\Jakub\\Desktop\\ode-generator\\build\\libs\\ode-generator-1.3.3-2-all.jar")

    private fun KotlinDynamicParamsOdeTransitionSystem.checkSuccessors(from: Int, bounds: Map<Int, MutableSet<Rectangle>>) {
    ...
    private fun KotlinDynamicParamsOdeTransitionSystem.checkPredecessors(from: Int, bounds: Map<Int, MutableSet<Rectangle>>) {
