...
class KotlinDynamicParamsOdeTransitionSystemTwoDimTest {
    ...
    private val fragmentOne = KotlinDynamicParamsOdeTransitionSystem(OdeModel(listOf(v1, v2), listOf(
    ...
    private val fragmentTwo = KotlinDynamicParamsOdeTransitionSystem(OdeModel(listOf(v3, v4), listOf(
            OdeModel.Parameter(name = "p1", range = Pair(0.0, 2.0)),
            OdeModel.Parameter(name = "p2", range = Pair(0.0, 2.0))
    )), true,"C:\\Users\\Jakub\\Desktop\\ode-generator\\build\\libs\\ode-generator-1.3.3-2-all.jar")
    ...
    private fun checkTransitions(model: KotlinDynamicParamsOdeTransitionSystem, expectedTransitions: Map<Pair<Int, Int>, MutableSet<Rectangle>>) {
        model.run {
