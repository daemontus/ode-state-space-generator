...
class IntegrationTest {
    ...
    //TODO: Make some smaller tests
    //@Test fun TCBBTest() = integrationTest(File("models/tcbb.bio"), File("models/tcbb.transitions.smt.txt"))
    //@Test fun Model31Test() = integrationTest(File("models/model_31_reduced.bio"), File("models/model_31_reduced.transitions.smt.txt"))
