...
class DynamicParamsOdeTransitionSystemTwoDimTest {
    ...
    )), "/home/xracek6/ode-generator/build/libs/ode-generator-1.3.3-2-all.jar")
    ...
    private fun checkTransitions(model: DynamicParamsOdeTransitionSystem, expectedTransitions: Map<Pair<Int, Int>, MutableSet<Rectangle>>) {
        model.run {
