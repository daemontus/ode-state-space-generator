...
class OneDimNoParamGeneratorTest {
    ...
    private fun SMTOdeFragment.normalizedSuccessors(node: IDNode): List<Pair<IDNode, SMTColors>> {
        return this.successors.invoke(node).entries.map { Pair(it.key, it.value.normalize()) }.sortedBy { it.first.id }
    }

    private fun SMTOdeFragment.normalizedPredecessors(node: IDNode): List<Pair<IDNode, SMTColors>> {
        return this.predecessors.invoke(node).entries.map { Pair(it.key, it.value.normalize()) }.sortedBy { it.first.id }
    }
    ...
    @Test fun case0() {
        ...
        val c = fragment.fullColors
        val s0 = fragment.normalizedSuccessors(IDNode(0))
        assertEquals(listOf(n0 to c), s0)
        val s1 = fragment.normalizedSuccessors(IDNode(1))
        assertEquals(listOf(n1 to c), s1)
        val s2 = fragment.normalizedSuccessors(IDNode(2))
        assertEquals(listOf(n2 to c), s2)
        val p0 = fragment.normalizedPredecessors(IDNode(0))
        assertEquals(listOf(n0 to c), p0)
        val p1 = fragment.normalizedPredecessors(IDNode(1))
        assertEquals(listOf(n1 to c), p1)
        val p2 = fragment.normalizedPredecessors(IDNode(2))
        assertEquals(listOf(n2 to c), p2)
    }
    ...
    @Test fun case2() {
        ...
        val c = fragment.fullColors
        val s0 = fragment.normalizedSuccessors(IDNode(0))
        assertEquals(listOf(n0 to c, n1 to c), s0)
        val s1 = fragment.normalizedSuccessors(IDNode(1))
        assertEquals(listOf(n1 to c), s1)
        val s2 = fragment.normalizedSuccessors(IDNode(2))
        assertEquals(listOf(n2 to c), s2)
        ...
        assertEquals(listOf(n0 to c), p0)
        val p1 = fragment.normalizedPredecessors(IDNode(1))
        assertEquals(listOf(n0 to c, n1 to c), p1)
        val p2 = fragment.normalizedPredecessors(IDNode(2))
        assertEquals(listOf(n2 to c), p2)
    }
    ...
    @Test fun case4() {
        ...
        assertEquals(listOf(n0 to c), s0)
        val s1 = fragment.normalizedSuccessors(IDNode(1))
        assertEquals(listOf(n0 to c, n1 to c), s1)
        val s2 = fragment.normalizedSuccessors(IDNode(2))
        assertEquals(listOf(n2 to c), s2)
        val p0 = fragment.normalizedPredecessors(IDNode(0))
        assertEquals(listOf(n0 to c, n1 to c), p0)
        val p1 = fragment.normalizedPredecessors(IDNode(1))
        assertEquals(listOf(n1 to c), p1)
        val p2 = fragment.normalizedPredecessors(IDNode(2))
        assertEquals(listOf(n2 to c), p2)
    ...
    @Test fun case5() {
        ...
        val c = fragment.fullColors
        val s0 = fragment.normalizedSuccessors(IDNode(0))
        assertEquals(listOf(n1 to c), s0)
        val s1 = fragment.normalizedSuccessors(IDNode(1))
        assertEquals(listOf(n1 to c), s1)
        val s2 = fragment.normalizedSuccessors(IDNode(2))
        assertEquals(listOf(n2 to c), s2)
        val p0 = fragment.normalizedPredecessors(IDNode(0))
        assertEquals(listOf<Pair<IDNode, SMTColors>>(), p0)
        val p1 = fragment.normalizedPredecessors(IDNode(1))
        assertEquals(listOf(n0 to c, n1 to c), p1)
        val p2 = fragment.normalizedPredecessors(IDNode(2))
        assertEquals(listOf(n2 to c), p2)
    ...
    @Test fun case6() {
        ...
        assertEquals(listOf(n0 to c), s0)
        val s1 = fragment.normalizedSuccessors(IDNode(1))
        assertEquals(listOf(n1 to c, n2 to c), s1)
        val s2 = fragment.normalizedSuccessors(IDNode(2))
        assertEquals(listOf(n2 to c), s2)
        val p0 = fragment.normalizedPredecessors(IDNode(0))
        assertEquals(listOf(n0 to c), p0)
        ...
        assertEquals(listOf(n1 to c), p1)
        val p2 = fragment.normalizedPredecessors(IDNode(2))
        assertEquals(listOf(n1 to c, n2 to c), p2)
    }
    //+..0..0..+
    @Test fun case7() {
    ...
    @Test fun case8() {
        ...
        assertEquals(listOf(n0 to c, n1 to c), s0)
        val s1 = fragment.normalizedSuccessors(IDNode(1))
        assertEquals(listOf(n2 to c), s1)
        val s2 = fragment.normalizedSuccessors(IDNode(2))
        assertEquals(listOf(n2 to c), s2)
        val p0 = fragment.normalizedPredecessors(IDNode(0))
        assertEquals(listOf(n0 to c), p0)
        val p1 = fragment.normalizedPredecessors(IDNode(1))
        assertEquals(listOf(n0 to c), p1)
        val p2 = fragment.normalizedPredecessors(IDNode(2))
        assertEquals(listOf(n1 to c, n2 to c), p2)
    }
    ...
    @Test fun case10() {
        ...
        assertEquals(listOf(n1 to c), s1)
        val s2 = fragment.normalizedSuccessors(IDNode(2))
        assertEquals(listOf(n1 to c, n2 to c), s2)
        val p0 = fragment.normalizedPredecessors(IDNode(0))
        assertEquals(listOf(n0 to c), p0)
        val p1 = fragment.normalizedPredecessors(IDNode(1))
        assertEquals(listOf(n1 to c, n2 to c), p1)
        val p2 = fragment.normalizedPredecessors(IDNode(2))
        assertEquals(listOf(n2 to c), p2)
    }
    //-..0..0..-
    ...
    @Test fun case12() {
        ...
        assertEquals(listOf(n0 to c), s0)
        val s1 = fragment.normalizedSuccessors(IDNode(1))
        assertEquals(listOf(n0 to c), s1)
        val s2 = fragment.normalizedSuccessors(IDNode(2))
        assertEquals(listOf(n1 to c, n2 to c), s2)
        val p0 = fragment.normalizedPredecessors(IDNode(0))
        assertEquals(listOf(n0 to c, n1 to c), p0)
        val p1 = fragment.normalizedPredecessors(IDNode(1))
        assertEquals(listOf(n2 to c), p1)
        val p2 = fragment.normalizedPredecessors(IDNode(2))
        assertEquals(listOf(n2 to c), p2)
    }
    ...
    @Test fun case15() {
        ...
        assertEquals(listOf(n0 to c), s1)
        val s2 = fragment.normalizedSuccessors(IDNode(2))
        assertEquals(listOf(n1 to c), s2)
        val p0 = fragment.normalizedPredecessors(IDNode(0))
        assertEquals(listOf(n0 to c, n1 to c), p0)
        val p1 = fragment.normalizedPredecessors(IDNode(1))
        assertEquals(listOf(n2 to c), p1)
    ...
    @Test fun case24() {
        ...
        assertEquals(listOf(n0 to c), p0)
        val p1 = fragment.normalizedPredecessors(IDNode(1))
        assertEquals(listOf(n0 to c, n1 to c, n2 to c), p1)
        val p2 = fragment.normalizedPredecessors(IDNode(2))
        assertEquals(listOf(n2 to c), p2)
    }
    //0..-..+..0
    @Test fun case25() {
        ...
        assertEquals(listOf(n0 to c), s0)
        val s1 = fragment.normalizedSuccessors(IDNode(1))
        assertEquals(listOf(n0 to c, n1 to c, n2 to c), s1)
        val s2 = fragment.normalizedSuccessors(IDNode(2))
        assertEquals(listOf(n2 to c), s2)
        val p0 = fragment.normalizedPredecessors(IDNode(0))
        assertEquals(listOf(n0 to c, n1 to c), p0)
